...
#' @details The superfast method fails when the circulant matrix is not positive definite.  This is typically due to one of two things, to which the fft algorithm can be tuned with \code{tol} and \code{nkeep}:
#' \itemize{
